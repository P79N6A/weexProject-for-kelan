<template>
	<div class="container">
		...
		<scroller style="flex: 1;">
			...
			<div class="center">
				<div class="item">
					<text class="fontIL">转入账户</text>
					<text class="fontIR">农商财富稳40天</text>
				</div>
			</div>
			<div class="bottom">
				<div class="item1">
...
<script>
	...
	import bottomDialog from "@/components/myCount/bottomDialog.vue"
