<template>
	<div class="container">
		...
		<scroller style="flex: 1;">
			<top :list="list" :CommonPayerAcNoList="CommonPayerAcNoList"></top>
			<center></center>
		</scroller>
...
<script>
	...
	import top from "@/components/deposit/depositJJG/top.vue";
	import center from "@/components/deposit/depositJJG/center.vue";
	...
	export default{
		...
		methods:{
			listInit(){
				this.postDo("FestProductBuyPre.do",{},data=>{
			...
			//跳转购买页面
			gotoBuy(){
				// this.$store.state.rateItem = item;
