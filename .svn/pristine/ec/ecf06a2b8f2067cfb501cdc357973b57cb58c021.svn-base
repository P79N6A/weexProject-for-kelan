<template>
	<div class="container">
		<mp-bar title="设置登录密码" :barStyle="barStyle" :titleStyle="titleStyle" :leftBtn="leftBtn" :leftBtnStyle="leftBtnStyle" @mpBarLeftBtnClick="mpBarLeftBtnClick"></mp-bar>
	...
	export default {
		...
		methods:{
			...
			last(){
				...
				this.postDo("SelfRegistration.do",param,data=>{
					this.showDialog = true;
					this.content = "恭喜您注册成功",
					this.btnText = "立即登录";
				},()=>{
					this.getToken();
				});
