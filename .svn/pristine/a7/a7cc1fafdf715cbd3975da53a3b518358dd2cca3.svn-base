...
<script>
	...
	import top from "@/components/deposit/depositFMD/top.vue";
	import center from "@/components/deposit/depositFMD/center.vue";
	...
	export default{
		...
		methods:{
			listInit(){
				this.postDo("BlessingProductBuyPre.do",{},data=>{
